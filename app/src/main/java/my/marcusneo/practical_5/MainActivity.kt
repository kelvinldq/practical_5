...
import my.marcusneo.practical_5.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        return when (item.itemId) {
            ...
            R.id.action_about -> {
                //nav graph way
//                val navController = findNavController(R.id.action_FirstFragment_to_secondActivity)
//                navController.navigate(R.id.action_FirstFragment_to_secondActivity)
                ...
                true}
            R.id.action_upload -> {
                contactViewModel.uploadContact()
            true}
            R.id.action_download ->{
                //downloadContact(this,getString(R.string.url_server) + getString(R.string.url_get_all_profile))
                true
            }
                ...
                try {
                    if (response != null) {
                        ...
                        for (i in 0..size - 1) {
                            ...
                            contactViewModel.addContact(Contact(contact?.name!!, contact?.phone!!))
                        }
